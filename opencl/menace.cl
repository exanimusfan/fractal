...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/14 08:09:36 by viccarau          #+#    #+#             */
/*   Updated: 2019/06/16 22:19:38 by viccarau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_mdl	mdl_init(t_krn k, double xoffset, double yoffset)
{
	...
	m.x_origin = 0.314784;
	m.y_origin = 0.027747;
	m.x = ((((double)m.x_dim / m.width) * k.xmax - k.xmin))  + k.xoffset;
	m.y = ((((double)m.y_dim / m.height) * k.ymax - k.ymin)) + k.yoffset;
	return (m);
}
